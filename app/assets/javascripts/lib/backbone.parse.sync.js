...
(function() {
	...
	var original_toJSON =FbCURank.Entities.ParseModel.prototype.toJSON; 
    var ParseModel = {
    ...
    _.extend(FbCURank.Entities.ParseModel.prototype, ParseModel);
    ...
    */
    original_parse = FbCURank.Entities.ParseCollection.prototype.parse; 
    var ParseCollection = {
    ...
    _.extend(FbCURank.Entities.ParseCollection.prototype, ParseCollection);
    ...
    */
	...
	Backbone.parseSync = function(method, model, options) {
	...
	FbCURank.Entities.ParseModel.prototype.sync = Backbone.parseSync;   
	FbCURank.Entities.ParseCollection.prototype.sync = Backbone.parseSync;     
